...
def last(input_list):
    ...
    return input_list[2]    # Did not work with 'return [il[i]]'
...
def first_three(input_list):
    ...
    return input_list[0:3]      # Same as line 39 comment.
...
def last_five(input_list):
    ...
    return input_list[5:]   # Why doesn't [-1:-6] work?
...
def middle(input_list):
    ...
    return input_list[2:-2] # Start: 2(inclussive) | End:-2 (not inc)
...
def inner_four(input_list):
    ...
    return input_list[2:6]  # How to print non-conseq. items?
...
def replace_head(input_list):
    ...
    """
    input_list[0] = 42  # Is there a better way to write this?
...
def replace_third_and_last(input_list):
    ...
    """
    input_list[2] = 37    # Is there a better way? 
    input_list[-1] = 37   # What if I want list with new elements?
    pass
...
def replace_middle(input_list):
    ...
    """
    input_list[2:-2] = 42, 37   # Is this the best way?

    pass


def delete_third_and_seventh(input_list):   # UNSOLVED!!
    ...
    """
    # del input_list[2]     # `del` is dangerous, deletes 4ever
    # del input_list[6]
    # input_list[2:3] = []  # <-- Once i[2] is removed, i[6] == i[5] 
    # input_list[5:6] = []
    input_list.pop(6)       # <-- Once i[2] is .popped, i[6] == i[5]
    input_list.pop(2)
